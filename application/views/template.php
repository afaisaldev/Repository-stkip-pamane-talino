...
<head>
  ...
  <!-- Font Awesome -->
  <link rel="stylesheet" href="https://repository.stkippamanetalino.ac.id/assets/bower_components/font-awesome/css/font-awesome.min.css">
  <!-- Ionicons -->
  <link rel="stylesheet" href="https://repository.stkippamanetalino.ac.id/assets/bower_components/Ionicons/css/ionicons.min.css">
  <!-- DataTables -->
  
  <!-- Theme style -->
  <link rel="stylesheet" href="https://repository.stkippamanetalino.ac.id/assets/dist/css/AdminLTE.min.css">
  <!-- AdminLTE Skins. Choose a skin from the css/skins
       folder instead of downloading all of them to reduce the load. -->
  <link rel="stylesheet" href="https://repository.stkippamanetalino.ac.id/assets/dist/css/skins/_all-skins.min.css">
  <!-- bootstrap datepicker -->
  <link rel="stylesheet" href="https://repository.stkippamanetalino.ac.id/assets/bower_components/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css">
...
<!-- AdminLTE App -->
<script src="https://repository.stkippamanetalino.ac.id/assets/dist/js/adminlte.min.js"></script>
<!-- AdminLTE for demo purposes -->
<script src="https://repository.stkippamanetalino.ac.id/assets/dist/js/demo.js"></script>
<!-- bootstrap datepicker -->
<script src="https://repository.stkippamanetalino.ac.id/assets/bower_components/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js"></script>
<!-- page script -->
<script>
  $(function () {
    $('.example1').DataTable({
